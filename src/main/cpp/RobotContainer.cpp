...
void RobotContainer::ConfigureBindings()
{
    ...
    driverJoystick.X().OnTrue(m_intakeSubsystem.SetGoalAngle());
    ...
    driverJoystick.LeftBumper().OnFalse(m_intakeSubsystem.SpinMotor(0_V));
    driverJoystick.LeftBumper().OnTrue(m_intakeSubsystem.SpinMotor(-5_V));
    ...
    operatorJoystick.LeftTrigger().WhileTrue(m_intakeSubsystem.SpinUntilExtendLimit());
    operatorJoystick.LeftTrigger().OnFalse(m_intakeSubsystem.StopSpin());
    operatorJoystick.RightTrigger().WhileTrue(m_intakeSubsystem.SpinUntilStowLimit());
    operatorJoystick.RightTrigger().OnFalse(m_intakeSubsystem.StopSpin());
