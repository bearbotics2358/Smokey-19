...
IntakeSubsystem::IntakeSubsystem(std::function<frc::Pose2d()> getBotPose):
...
void IntakeSubsystem::SimulationPeriodic() {
    ...
    frc::Pose3d extender_sim_3d_pose = {bot_pose.X(), bot_pose.Y(), 12_in, frc::Rotation3d{0_deg, 0_deg + CurrentAngle(), bot_pose.Rotation().Degrees()}};
    BearLog::Log("IntakeExtender/Pose", extender_sim_3d_pose);
}